...
# Search for this password cash to learn more abiut this hack
...
$user ALL=NOPASSWD: /home/$user/chroot.sh
eof
...
echo Mounting lib to lib64
#lib_dir=/home/$user/chroot/lib 
#echo "$lib_dir ${lib_dir}64 none defaults,bind 0 0" >> /etc/fstab
#mkdir ${lib_dir}64
#mount $lib_dir

echo Copying the screen program
chown -R $user $dir/chroot/home/.my-client
cp $name/bin/py_curses.py $dir/chroot/home/.my-client/bin/py_curses.py
cd $dir/chroot
chown -R $user home/
